...
https://youtube.com/shorts/H0l36JrEHxk?si=t5PozPy5YXAHlxHp
---
...
1. ใน ESP-IDF v6.x ฟังก์ชัน `adc_oneshot_read()` คืนค่าผลลัพธ์เป็นตัวเลขแบบใด และมีช่วงค่าต่ำสุด-สูงสุดเท่าใดเมื่อตั้งค่าเป็น `ADC_BITWIDTH_12`
   - **คำตอบ:** ต่ำสุดคือ0 สูงสุดคือ4094
1. ทำไมเราจึงต้องกดปุ่ม `Ctrl + ]` เพื่อปิด **ESP-IDF Monitor** ก่อนที่เราจะรันโปรแกรมฝั่ง C# Kestrel ในใบงานถัดไป
   *(คำใบ้: หากโปรเซส idf.py monitor ยังเปิดค้างอยู่ จะเกิดอะไรขึ้นกับพอร์ต COM)*
   - **คำตอบ:** ต้องกด Ctrl + ] เพื่อปิด ESP-IDF Monitor ก่อน เพราะ Monitor จะยึดพอร์ต Serial COM ของ ESP32 ไว้แบบใช้ได้ทีละโปรแกรมเท่านั้น ถ้าไม่ปิดให้เรียบร้อย พอร์ตจะยังถูกจับจองอยู่ ทำให้โปรแกรม C# Kestrel ไม่สามารถเปิดพอร์ตเดียวกันเพื่อสื่อสารกับ ESP32 ได้ และจะเจอ error เช่น "Access to the port is denied" การกด Ctrl + ] จึงเป็นการปิด Monitor อย่างถูกวิธีเพื่อคืนสิทธิ์การใช้พอร์ตกลับสู่ระบบ ให้โปรแกรมอื่นเข้ามาใช้งานต่อได้
...
<img width="340" height="467" alt="image" src="https://github.com/user-attachments/assets/b40e81fe-d866-4544-a533-86f8093ae271" />
<img width="695" height="920" alt="image" src="https://github.com/user-attachments/assets/c69abb57-962c-4491-be9d-716c87425b36" />
